  ...
  return (
    ...
    <div className="container">
      <h1 style={{color: props.mode === "dark"?"white":"black"}}>{props.heading}</h1>
        ...
        <button className="btn btn-dark mx-1" onClick={upperCase}>To Uppercase</button>
        <button className="btn btn-dark mx-1" onClick={lowerCase}>To Lowercase</button>
        <button className="btn btn-dark mx-1" onClick={clear}>Clear</button>
